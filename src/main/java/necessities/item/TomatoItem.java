...
import necessities.entity.TomatoEntity;
...
public class TomatoItem extends Item implements ProjectileItem {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            TomatoEntity entity = new TomatoEntity(world, user);
    ...
    public ProjectileEntity createEntity(World world, Position pos, ItemStack stack, Direction direction) {
        TomatoEntity entity = new TomatoEntity(world, pos.getX(), pos.getY(), pos.getZ());
